vim.g['far#window_width'] = 150
vim.g['far#file_mask_favorites'] = {'%:p', '**', '**/README.md', '**/package.json', '**/*.js', '**/*.ts', '**/*.tsx', '**/*.py', '**/*.css', '**/*.html', '**/*.vim'}
vim.g['far#window_min_content_width'] = 50
vim.g['far#enable_undo'] = 1
vim.g['far#ignore_files'] = {'~/.config/nvim/utils/farignore'}

vim.cmd('set wildignore+=**/node_modules/**,yarn.lock,package-lock.json,**/dist/**')
