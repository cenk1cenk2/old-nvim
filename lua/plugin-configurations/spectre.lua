...
vim.api.nvim_set_keymap('n', [[sa]], [[:lua require('spectre').open()<cr>]], {silent = true, noremap = true})
vim.api.nvim_set_keymap('v', [[sa]], [[:lua require('spectre').open()<cr>]], {silent = true, noremap = true})
