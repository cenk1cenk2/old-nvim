...
let g:which_key_map.b = {
      ...
      \ 'f' : [':CocCommand fzf-preview.Buffers --preview "bat --style=numbers --color=always --line-range :500 {}"'                , 'fzf-buffers'],
      \ 'F' : [':CocCommand fzf-preview.AllBuffers --preview "bat --style=numbers --color=always --line-range :500 {}"'                , 'fzf-all-buffers'],
...
let g:which_key_map.f = {
      ...
      \ 'f' : [':CocCommand fzf-preview.ProjectFiles --preview "bat --style=numbers --color=always --line-range :500 {}"', 'files in project'],
      \ 'F' : [':FZF'                   , 'FZF'],
      \ 'g' : [':GFiles?'               , 'modified git files'],
      \ 'G' : [':CocCommand fzf-preview.GitFiles --preview "bat --style=numbers --color=always --line-range :500 {}"', 'git files'],
      \ 'h' : [':History'               , 'file history'],
      \ 'H' : [':History:'              , 'command history'],
      \ 'l' : [':Lines'                 , 'text in open buffers'] ,
      \ 'm' : [':CocCommand fzf-preview.Marks --preview "bat --style=numbers --color=always --line-range :500 {}"', 'list marks'],
